...
for i=1:iter
    Yq(1:2^(8-i),2^(8-i)+1:2^(8-i+1)) = quant1(Yq(1:2^(8-i),2^(8-i)+1:2^(8-i+1)), q*ratio(i,1), q*ratio(i, 1));
    Yq(2^(8-i)+1:2^(8-i+1),2^(8-i)+1:2^(8-i+1)) = quant1(Yq(2^(8-i)+1:2^(8-i+1),2^(8-i)+1:2^(8-i+1)), q*ratio(i,2), q*ratio(i, 2));
    Yq(2^(8-i)+1:2^(8-i+1),1:2^(8-i)) = quant1(Yq(2^(8-i)+1:2^(8-i+1),1:2^(8-i)), q*ratio(i,3), q*ratio(i,3));
end

Yq(1:2^(8-iter), 1:2^(8-iter)) = quant1(Yq(1:2^(8-iter), 1:2^(8-iter)), q*ratio(iter+1, 1));
