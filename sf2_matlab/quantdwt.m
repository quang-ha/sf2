...
switch iter
    case 1
        ...
        ratio = [1.91666 1 1.91666; 1.91667 0 0];
    case 2
...
for i=1:iter
    Yq(1:2^(8-i),2^(8-i)+1:2^(8-i+1)) = quantise(Yq(1:2^(8-i),2^(8-i)+1:2^(8-i+1)), q*ratio(i,1), q*ratio(i, 1));
    Yq(2^(8-i)+1:2^(8-i+1),2^(8-i)+1:2^(8-i+1)) = quantise(Yq(2^(8-i)+1:2^(8-i+1),2^(8-i)+1:2^(8-i+1)), q*ratio(i,2), q*ratio(i, 2));
    Yq(2^(8-i)+1:2^(8-i+1),1:2^(8-i)) = quantise(Yq(2^(8-i)+1:2^(8-i+1),1:2^(8-i)), q*ratio(i,3), q*ratio(i,3));
end

Yq(1:2^(8-iter), 1:2^(8-iter)) = quantise(Yq(1:2^(8-iter), 1:2^(8-iter)), q*ratio(iter+1, 1));
